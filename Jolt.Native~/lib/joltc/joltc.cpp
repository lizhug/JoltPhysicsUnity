...
void JPH_SixDOFConstraint_GetMotorSettings(JPH_SixDOFConstraint* constraint, JPH_MotorSettings* settings, JPH_SixDOFConstraintAxis axis)
{
	JPH::MotorSettings& joltSettings = AsSixDOFConstraint(constraint)->GetMotorSettings(static_cast<JPH::SixDOFConstraint::EAxis>(axis));
	joltSettings = ToJolt(settings);
}
...
void JPH_SixDOFConstraint_SetTargetVelocityCS(JPH_SixDOFConstraint* constraint, Vec3Arg inVelocity)
{
	AsSixDOFConstraint(constraint)->SetTargetVelocityCS(inVelocity);
}
...
void JPH_SixDOFConstraint_SetTargetAngularVelocityCS(JPH_SixDOFConstraint* constraint, Vec3Arg inAngularVelocity)
{
	AsSixDOFConstraint(constraint)->SetTargetAngularVelocityCS(inAngularVelocity);
}
...
void JPH_SixDOFConstraint_SetTargetPositionCS(JPH_SixDOFConstraint* constraint, Vec3Arg inPosition)
{
	AsSixDOFConstraint(constraint)->SetTargetPositionCS(inPosition);
}
...
void JPH_SixDOFConstraint_SetTargetOrientationCS(JPH_SixDOFConstraint* constraint, QuatArg inOrientation)
{
	AsSixDOFConstraint(constraint)->SetTargetOrientationCS(inOrientation);
}
...
void JPH_SixDOFConstraint_SetTargetOrientationBS(JPH_SixDOFConstraint* constraint, QuatArg inOrientation)
{
	AsSixDOFConstraint(constraint)->SetTargetOrientationBS(inOrientation);
}
